...
- Update Menu to git pull module changes
- Alert Menu to send alerts/notifications to mirror
- Restart will also refresh browser page after 60 seconds
- Successful status updates with 'info' will show alert
